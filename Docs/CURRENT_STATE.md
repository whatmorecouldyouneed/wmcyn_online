...
- Deployment remains open: Firebase Functions must be deployed with `WMCYN_RUNTIME_SERVER_KEY` and `WMCYN_JOIN_TICKET_SECRET` once billing is restored, and the canonical runtime needs an internet-reachable host.
