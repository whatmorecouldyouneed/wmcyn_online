...
- Use Quest right `B`/desktop `M` to toggle the runtime menu and `Escape` to close it on desktop. The pointer ray appears while login or the runtime menu is active.
